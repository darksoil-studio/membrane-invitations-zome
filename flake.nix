{
  ...
  outputs = inputs:
    inputs.flake-parts.lib.mkFlake { inherit inputs; } {
      imports = [
        ./zomes/integrity/membrane_invitations/zome.nix
        ./zomes/coordinator/membrane_invitations/zome.nix
        ...
        packages.scaffold = pkgs.symlinkJoin {
          ...
          postBuild = ''
            wrapProgram $out/bin/scaffold-remote-zome \
              --add-flags "membrane-invitations-zome \
                --integrity-zome-name membrane_invitations_integrity \
                --coordinator-zome-name membrane_invitations \
                --remote-zome-git-url github:darksoil-studio/membrane-invitations-zome \
                --remote-npm-package-name @darksoil-studio/membrane-invitations-zome \
                --remote-zome-git-branch main-0.5 \
                --context-element membrane-invitations-context \
                --context-element-import @darksoil-studio/membrane-invitations-zome/dist/elements/membrane-invitations-context.js" 
          '';
        };
      };
    };
